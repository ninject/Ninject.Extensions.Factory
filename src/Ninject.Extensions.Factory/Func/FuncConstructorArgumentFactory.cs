...
namespace Ninject.Extensions.Factory
{
    ...
    /// <summary>
    /// Factory for creating FuncConstructorArgument instances.
    /// </summary>
    public static class FuncConstructorArgumentFactory
    {
        /// <summary>
        /// Creates instances of FuncConstructorArgument.
        /// </summary>
        /// <param name="typeArgument">The type of the argument.</param>
        /// <param name="value">The value of the argument.</param>
        /// <returns>The newly created FuncConstructorArgument.</returns>
